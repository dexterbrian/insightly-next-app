    ...
    return (
        <>
            <header className="flex items-center justify-between whitespace-nowrap px-10 py-3">
                <div onClick={() => window.location.href = '/'} className="cursor-pointer flex items-center gap-4 text-[#111418]">
                    ...
                    <h2 className="text-[#111418] dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">Insightly</h2>
                </div>
